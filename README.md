...
* @Given-annotated classes are scanned for @Given-annotated instance and static methods and they are executed before each test runs. Useful for setting each test. All classes are scanned unless the "given.scan.package" environment variable is set to the package prefix you desire.
